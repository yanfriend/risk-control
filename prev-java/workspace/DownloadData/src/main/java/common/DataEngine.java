...
// import monitor.PriceMonitorStrategy;
...
//    	accountMonitor.checkContract(contract, position); 
    ...
    public synchronized int reqRealtimeBar(Strategy strategy, String priceType, boolean useRTH) 
    {
        int requestId = getNextID();   
    ...
    public synchronized int reqRealtimeBar(Security security, String priceType, boolean useRTH) 
    {
        Contract contract = new Contract ();
        contract.m_currency = "USD"; 
        contract.m_symbol = security.getSymbol();
