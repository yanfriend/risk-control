...
//    	}
	...
	public void monitor() {
        ...
        timer.scheduleAtFixedRate(new TimerTask() {
        	public void run() {
        		if (currentPrice<=0) {
        			dataEngine.reqRealtimeBar(Doji.this, PriceTypeEnum.TRADES.toString(), true);
        		}
        	    ...
        	    dataEngine.reqHistoricalData(Doji.this, endDateTime, "3 D", "30 mins", "TRADES", 1, 2);   
