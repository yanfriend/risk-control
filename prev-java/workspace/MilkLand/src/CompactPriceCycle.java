...
public class CompactPriceCycle {
	final static int INIT_YEAR = 1999;
	...
	boolean processDate(BufferedReader in, double[][][] yearPrice) {
		String str;
	    ...
	    while ((str = in.readLine()) != null) {
    		...
    		double close = Double.parseDouble(strArr[1].trim());
    		if (close <=0 ) {
